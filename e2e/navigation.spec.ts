...
test.describe("Navigation", () => {
  ...
  test("clicking Featured scrolls to Featured section", async ({ page }) => {
    await page
      .getByRole("navigation")
  ...
  test("clicking Experience scrolls to Experience section", async ({
    page,
  }) => {
    await page
      .getByRole("navigation")
  ...
  test("footer Summary link scrolls to Professional Summary", async ({
    page,
  }) => {
  ...
  test("footer Skills link scrolls to Skills heading visible", async ({
    page,
  }) => {
  ...
  test("footer Certifications link scrolls to Certifications heading visible", async ({
    page,
  }) => {
    ...
    const heading = page
      .getByRole("heading", { name: /certifications/i })
      .first();
    await expect(heading).toBeVisible();
  });
});
