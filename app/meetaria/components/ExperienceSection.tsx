...
const FADE = 'linear-gradient(to right, transparent 0%, black 7%, black 93%, transparent 100%)';
    ...
    >
      <div className="max-w-7xl mx-auto px-5 sm:px-6">
        ...
        <div className="mt-20">
          ...
          >
            {FRAMES.map((frame) => (
              <div key={frame.id} className="snap-center shrink-0 flex flex-col items-center gap-3">
                <div
                  className={frame.type === 'mac' ? 'w-105' : 'w-46.25'}
                  style={{ filter: 'drop-shadow(0 16px 40px rgba(0,0,0,0.22))' }}
                >
                  <Image
                    src={frame.type === 'mac' ? '/ARIA-web.png' : '/ARIA-mini.png'}
                    alt={frame.caption}
